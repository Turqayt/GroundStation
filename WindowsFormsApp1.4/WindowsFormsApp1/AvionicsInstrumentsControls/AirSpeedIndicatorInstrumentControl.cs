...
namespace WindowsFormsApp1
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WindowsFormsApp1.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(WindowsFormsApp1.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.AirSpeedNeedle);
        ...
        public void SetAirSpeedIndicatorParameters(float aircraftAirSpeed)
        {
